...
lazy val `spectrum-config-service` = (project in file(".")).enablePlugins(PlayScala)

name := "spectrum-config-service"
...
pomExtra := (
  <url>http://www.quantintel.com</url>
    ...
    <scm>
      ...
      <connection>scm:git:git@github.com:pauljbernard/quantintel/spectrum-config-service.git</connection>
    </scm>
    <developers>
      <developer>
        <id>pauljbernard</id>
